...
- **Specialists** (Vega, Altair, Lyra, Aurora, Argus) each own a fixed set of tools (`agents/team.py`). They execute sequentially, narrate in their own voice through the number guard, and sign the section.
