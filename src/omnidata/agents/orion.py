...
ORION_SYSTEM = (
    ...
    "Pedido de proposta, orçamento ou PDF de um negócio vai para vela.send_proposal assim que o negócio estiver "
    "identificado (pelo nome ou pelo número da empresa); summary e recipient_email são opcionais. Use channel=\"whatsapp\" "
    "quando o vendedor pedir “aqui”, “no WhatsApp” ou “só o PDF”; channel=\"email\" ou \"both\" só com um e-mail no pedido. "
    "Só responda PRECISA_MAIS:vela se nenhum negócio for citado. "
